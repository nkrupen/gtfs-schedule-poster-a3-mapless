...
1. **Python 3.8+**
2. **Google Chrome / Chromium:** The script relies on the Chrome CLI (`google-chrome --headless`) to generate the PDFs. Chrome *must* be installed on your system and available in your system's PATH.
...
3. Ensure you have your `gtfs.zip` file and your `assets/logo.svg` in place.
