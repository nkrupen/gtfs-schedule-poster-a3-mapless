...
class GTFSSchedulePoster:
    ...
    def generate_poster(self, stop_id, date_label, city, school_week_start, holiday_week_start, output_file, skip_pdf_conversion=False):
        ...
        try:
            ...
            bus_icon_raw = self._read_svg_candidates(["assets/bus-icon.svg", "bus-icon.svg"])
            ...
            # Note: margin=0 removes the white borders generated by the API itself
            ...
            logo_svg_inline = self._read_svg_candidates(["assets/logo.svg", "logo.svg"])
            alareuna_svg_inline = self._read_svg_candidates(["assets/alareuna.svg", "alareuna.svg"])
...
<style>
    ...
    /* Removed white background and padding here */
    .qr-box {{
        width: 240px;
        height: 240px;
    }}
...
if __name__ == "__main__":
    ...
    if os.path.exists(gtfs_file):
        ...
        print(f"GTFS zip not found. Please ensure {gtfs_file} is in the directory.")
